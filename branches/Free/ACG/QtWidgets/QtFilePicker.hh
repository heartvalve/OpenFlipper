...
#ifndef QTFILEPICKER_HH_
#define QTFILEPICKER_HH_
...
class QtFilePicker : public QWidget {
    Q_OBJECT
    ...
    public:
        ...
        explicit QtFilePicker(QWidget *parent = 0);
        explicit QtFilePicker(QString recent_files_ini_key,
                              DialogType dialog_type,
                              QWidget *parent = 0);
        virtual ~QtFilePicker();
