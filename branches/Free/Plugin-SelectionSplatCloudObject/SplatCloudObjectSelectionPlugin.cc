...
void SplatCloudObjectSelectionPlugin::loadSelection( int _objId, const QString &_filename )
{
	// Load ini file
	INIFile file;
...
void SplatCloudObjectSelectionPlugin::loadIniFile( INIFile &_ini, int _id )
{
	BaseObjectData *object = 0;
...
void SplatCloudObjectSelectionPlugin::saveIniFile( INIFile &_ini, int _id )
{
	BaseObjectData *object = 0;
	if( !PluginFunctions::getObject( _id, object ) )
	{
