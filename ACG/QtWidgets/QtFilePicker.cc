...
#include "QtFilePicker.hh"

#include <QHBoxLayout>
#include <QMessageBox>

QtFilePicker::QtFilePicker(QWidget *parent) :
    QWidget(parent),
    textBox_(new QComboBox),
    browseButton_(new QPushButton(trUtf8("Browse…"))),
    recent_files_ini_key_("GenericQtFilePickerRecents"),
...
QtFilePicker::QtFilePicker(QString recent_files_ini_key,
...
void QtFilePicker::set_recent_files_ini_key(QString value) {
...
void QtFilePicker::path_changed() {
    overwrite_confirmed_by_user_ = false;
}

bool QtFilePicker::confirm_overwrite_if_necessary() {
