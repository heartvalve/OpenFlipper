    ...
    LoggingInterface, ScriptInterface
{
  ...
  private:
    ...
    template <class MeshT>
    bool writeMeshFileAscii(QString _filename, MeshT* _mesh, std::streamsize _precision);

    template <class MeshT>
    bool writeMeshFileBinary(QString _filename, MeshT* _mesh, std::streamsize _precision);
